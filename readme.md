...
Building on [prior explorations with CRUD and Image Uploads](https://github.com/ixd-system-design/Uploading-Images), this demo adds functionality for user authentication [via Auth0](https://auth0.com/) and the [Express OpenID Connect](https://github.com/auth0/express-openid-connect) library. The application uses MongoDB to persist data and to define the owner of each record. Accordingly, our [Prisma](https://www.prisma.io/orm) schema includes models for both users and albums.

Backend endpoints include the following logic:

*   Only authenticated users can create, update, or delete album records.
*   Each album record is associated with the user who created it.
*   Users can only modify or delete their own album records.
*   All users can view all album records, regardless of ownership.
